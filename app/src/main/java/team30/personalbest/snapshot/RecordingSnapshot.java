...
import team30.personalbest.service.recorder.IGoogleFitDataHandler;
...
public class RecordingSnapshot extends FitnessSnapshot implements IRecordingFitnessSnapshot, IGoogleFitDataHandler
{
	...
	public RecordingSnapshot(IFitnessService fitnessService)
	{
		this.setStartTime(fitnessService.getCurrentTime());
	}
